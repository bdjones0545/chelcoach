...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Uploaded video is deleted automatically 24 hours after upload (48 hours at most, if a job is still running). Your coaching reports and your chat with Scottie about them remain in your account so you can re-read them. Your gameplay profile is kept until you change it or delete your account.",
    ],
  },
  {
    ...
    bullets: [
      ...
      "xAI (the model that reads the sampled frames and answers your chat questions, via our own analysis gateway).",
...
export const TERMS_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Reports are generated from a small sample of frames by an automated system. They are estimates and observations, not measurements, and can be wrong. The Chel Rating is a rubric estimate and is labelled as such. Chat replies from Scottie are generated by the same system from your report and can be wrong in the same ways. Use the coaching as one input to your own judgment.",
    ],
  },
  {
    heading: "Fair use and limits",
    paragraphs: [
      "Each account has limits on concurrent and daily analyses and on daily questions to Scottie, and the service has an overall daily capacity. Do not attempt to bypass limits, probe the service, or upload content that is not yours.",
    ],
  },
  {
    heading: "Pricing",
