    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center px-4">
        <div className="max-w-md w-full glass-panel p-8 space-y-4">
          <h1 className="font-headline text-2xl uppercase text-on-surface">Sign in</h1>
          <p className="text-on-surface-variant text-sm">
            Local development uses automatic sessions. Supabase Auth is not configured in this
            build.
          </p>
          <Button onClick={() => navigate("/upload")}>Continue to upload</Button>
        </div>
      </div>
    );
  }
