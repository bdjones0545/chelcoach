...
| Tool | Returns |
| --- | --- |
| `chelcoach_get_analysis_status` | Whether the sample analysis has been viewed and whether the sample film room is unlocked; every report here is the built-in sample |
