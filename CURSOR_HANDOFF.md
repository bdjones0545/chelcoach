...
| ffmpeg / ffprobe | Required for live extraction (`docs/ffmpeg-extraction.md`). |
| Anthropic AI (`ANTHROPIC_API_KEY`) | Required for live AI analysis (see `docs/ai-gameplay-analysis.md`). |
...
- **AI analysis** — live mode uses vision analysis when configured; demo mode uses the sample report.
...
- **Phase 3** — ffmpeg frame extraction is implemented (`docs/ffmpeg-extraction.md`).
- **Phase 4** — Claude vision analysis (structured output against the Analysis Contract); see `docs/ai-gameplay-analysis.md`.
